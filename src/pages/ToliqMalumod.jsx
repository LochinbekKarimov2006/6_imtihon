...
function ToliqMalumod() {
  ...
  const [mainImage, setMainImage] = useState(datas.image4[0]);
  console.log(datas)
function rasimOzgartirish(e){
  setMainImage(e)
}
  console.log("fgdfs\dsdtfygu")
  function haridim(){
    console.log("salom")
...
<img
  ...
  />
  </button><button onclick={()=>{rasimOzgartirish(datas.image4[3])}}>
  ...
  />
        ...
        <div className="w-full md:w-1/2 px-4">
          ...
          <div className="flex space-x-4 mb-6">
            <button onClick={(e)=>{haridim()}} className="bg-indigo-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
